<template>
  <div>
    <h1 class="text">Edit Bike</h1>
    <form v-on:submit.prevent="editBlog">
      <p>
        <label for="Please enter a message">Title</label>
 ...
 <form enctype="multipart/form-data" novalidate>
        ...
        <div>
          <ul class="pictures">
            <li v-for="picture in pictures" v-bind:key="picture.id">
              ...
              />
              <br />
              <button v-on:click.prevent="useThumbnail(picture.name)" class="btn btn-warning">Thumbnail</button>
      ...
      <p>Author Name: <input class="form-control" type="text" v-model="blog.category" /></p>
      <!-- <p>status: <input class="form-control" type="text" v-model="blog.status" /></p> -->
      <p>
